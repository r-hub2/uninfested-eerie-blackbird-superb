...
## ----dpi=72, fig.alt="mean+-95%CI", fig.height=3, fig.width=4-----------------
dta <- GRD(
    RenameDV = "IQ",
...
## ----message=FALSE, dpi=72, fig.alt="mean+-95%CI", fig.height=3, fig.width=4----
dta <- GRD(
...
## ----dpi=72, fig.alt="mean+-95%CI", fig.width=4, fig.height=4-----------------
dta <- GRD(
