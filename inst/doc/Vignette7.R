...
## ----fig.alt="mean+-95%CI", fig.height=4, fig.width=3, fig.cap = "**Figure 1**. Plot of dtaHerero showing heterogeneous error bars."----
pt <- superb(
            score ~ group,
            dtaHetero, 
...
## ----fig.alt="mean+-95%CI", fig.height=4, fig.width=3, fig.cap = "**Figure 2**. Plot of dtaHerero with rectified degree of freedom."----
pw <- superb(
            score ~ group,
            dtaHetero, 
            adjustments = list(purpose = "difference"),
...
## ----fig.alt="mean+-95%CI", fig.height=4, fig.width=3, fig.cap = "**Figure 3**. Plot of dtaHerero with rectified degree of freedom and Tryon' difference-adjusted error bars."----
pwt <- superb(
            score ~ group, 
            dtaHetero, 
...
## ----fig.alt="mean+-95%CI", fig.height=4, fig.width=9, fig.cap = "**Figure 4**. All three plots with relevant markers in red."----
